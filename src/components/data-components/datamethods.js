    ...
    var innerContent=[
        ...
        <Col md={9}>
          ...
          <ol>
            ...
            <li>All survey responses are fully anonymized by SurveyMonkey. No responses contain any personally identifiable information (name, address, email address, IP address, profile images, birthdates, social media handles, etc.), and the participants are made aware of this.</li>
          ...
          * Any surveys that did not meet the above Data Collection criteria were not included in the aggregate analysis. If any additional non-individualized links were used in collection, we used SurveyMonkey’s collector filter feature to remove those responses from the analysis.
          </p>
        </Col>]
